 ...
 * @author lufer
 * @date 2022
 * @brief Lista Ligadas Simples e Árvores Binárias (versão 1)
 *
 * Dados globais para uma Lista Ligada Simples  e Árvores Binárias de Pessoas
 * @bug No known bugs.
*/
#pragma once
...
//Historico
ListaPessoa* RemovePessoaABP(ListaPessoa* h, int nc, Node **historico);
